...
# 1. Listas (list):
    ...
    # As listas no python são DINAMICAS e podem conter QUALQUER tipo de dados.
        # > Dinamica: 
            ...
            # e simplismente ir adicionando elementos enquanto houver memoria disponivel.
...
lista6 = [1, 2.34, True, "Geek", 'd', [1, 2, 3]]
...
"""
    ...
    # b. POP
    # lista.pop(indice) > remove o elemento do indice informado
"""
print(lista5)
lista5.pop(2)
print(lista5)
...
print(lista[:4]) # Começa em 0 e vai até 0 4-1
"""
